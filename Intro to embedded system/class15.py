...
def monitor_input():
	...
	while not stop_event.is_set():
		try:
			...
			if new_state == 0 and button_state == 1:  # Falling edge detected
				#print("\rSwitch pressed!", new_state)
				channel = (channel + 1) % 3
				led_state = not led_state
			if new_state == 1 and button_state == 1:  # Still high, do nothing
				pass
